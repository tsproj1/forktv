...
# 定义
urls1 = read_txt_to_array('mytv/urlsub.txt')
...
blank_video=get_random_url('assets/今日推荐.txt')
version=formatted_time+","+blank_video
# about="关于本源(iptv365.org),"+about_video2
# 瘦身版
# 
all_lines_simple =  ["更新时间,#genre#"] +[version]  +[daily_mtv]+[music_mtv]+ ['\n'] +\
...
# 
all_lines =  ["更新时间,#genre#"] +[version] +[daily_mtv]+[music_mtv] + ['\n'] +\
...
# 将合并后的文本写入文件
output_path="mytv/"
output_file = output_path + "merged_output.txt"
output_file_simple = output_path + "merged_output_simple.txt"
others_file = output_path + "others_output.txt"

# NEW将合并后的文本写入文件
new_output_file = output_path + "live.txt"
new_output_file_simple = output_path + "live_lite.txt"
